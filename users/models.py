...
class EmailVerification(models.Model):
    code = models.UUIDField(unique=True)   # Формируем универсальный Идентификатор
    user = models.ForeignKey(to=User, on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)   # Автоматическое заполнение при создани объекта
    expiration = models.DateTimeField()      # Добавления срока жизни ссылки
